...
function cout($text, $zone = false) {
	...
	if($GLOBALS['page'] && $GLOBALS['page'] instanceof StdPageWriter || $GLOBALS['page'] instanceof onecolPageWriter || $GLOBALS['page'] instanceof emptyPageWriter || $GLOBALS['page'] instanceof LmsPageWriter) 
		$GLOBALS['page']->add($text, $zone);
	else {
