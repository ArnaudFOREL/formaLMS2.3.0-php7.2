...
class JQueryLib
{
    ...
    public static function loadJsAddons($which_version, array $exclude_addons = [], $single_addon = null)
    {
    ...
    public static function loadCssAddons($which_version, array $exclude_addons = [], $single_addon = null)
    {
        if (!is_null($single_addon)){ 
