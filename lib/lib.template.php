...
function getTemplate() {
	...
	// force_standard mode
	if(isset($_REQUEST["notuse_template"]) || isset($GLOBALS['notuse_template']) && $GLOBALS['notuse_template'] == true){
...
{
	$stdPageWriter = new StdPageWriter();
	$stdPageWriter = $stdPageWriter->createInstance();

	//$GLOBALS['page'] = $stdPageWriter;
