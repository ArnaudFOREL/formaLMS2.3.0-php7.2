...
if($GLOBALS['page'] && $GLOBALS['page'] instanceof StdPageWriter || $GLOBALS['page'] instanceof onecolPageWriter || $GLOBALS['page'] instanceof emptyPageWriter)  $GLOBALS['page']->add(ob_get_contents(), 'debug');
ob_clean();
