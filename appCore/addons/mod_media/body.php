...
function show_personal_media(& $out, & $lang) {
	...
	$url = indexgetPopupBaseUrl()."&amp;op=addpersonal";
...
function add_personal_media(& $out, & $lang) {
	...
	$url 	= indexgetPopupBaseUrl()."&amp;op=inspersonal";
	$form 	= new Form();
...
function ins_personal_media() {
	...
	$url = indexgetPopupBaseUrl()."&amp;op=personal";
	...
	$url = 'addons/mod_media/'.indexgetPopupBaseUrl();
...
function del_personal_media(& $out, & $lang) {
	...
	if (isset($_POST["canc_del"])) {
		Util::jump_to(indexgetPopupBaseUrl()."&amp;op=personal");
	}
		...
		$GLOBALS['page']->add($form->openForm("popup_form", indexgetPopupBaseUrl()."&amp;op=delpersonal"));
...
function select_media(& $out, & $lang) {
	...
	$res="";
	$url=indexgetPopupBaseUrl()."&amp;op=main";
