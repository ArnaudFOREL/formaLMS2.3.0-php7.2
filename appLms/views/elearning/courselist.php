...
function GetCourseYear($the_course)
{
    ...
    $date_split = explode('-', $date_clean);
    return $date_split[2];
}

function GetCourseMonth($the_course)
{
    $dateEnd = Format::date($the_course['date_end'], 'date');
    $date_clean = str_replace('/', '-', $dateEnd); //To prevent the different formats of date
    $date_split = explode('-', $date_clean);

    $date = new DateTime();
    $date->setDate($date_split[2], $date_split[1], $date_split[0]);        
    $month_name = $date->format('M');
    switch ($month_name) {
        case 'Jan':
            $month_name = Lang::t('_MONTH_01', 'standard');
            break;

        case 'Feb':
            $month_name = Lang::t('_MONTH_02', 'standard');
            break;

        case 'Mar':
            $month_name = Lang::t('_MONTH_03', 'standard');
            break;

        case 'Apr':
            $month_name = Lang::t('_MONTH_04', 'standard');
            break;

        case 'May':
            $month_name = Lang::t('_MONTH_05', 'standard');
            break;

        case 'Jun':
            $month_name = Lang::t('_MONTH_06', 'standard');
            break;

        case 'Jul':
            $month_name = Lang::t('_MONTH_07', 'standard');
            break;

        case 'Aug':
            $month_name = Lang::t('_MONTH_08', 'standard');
            break;

        case 'Sep':
            $month_name = Lang::t('_MONTH_09', 'standard');
            break;

        case 'Oct':
            $month_name = Lang::t('_MONTH_10', 'standard');
            break;

        case 'Nov':
            $month_name = Lang::t('_MONTH_11', 'standard');
            break;

        case 'Dec':
            $month_name = Lang::t('_MONTH_12', 'standard');
            break;
