...
function checkRequirements() {
	...
	$res['php']=((version_compare(PHP_VERSION, '5.2.0', '>=') && version_compare(PHP_VERSION, '7.2.30', '<')) ? 'ok' :
                     ((version_compare(PHP_VERSION, '7.2.30', '>=') && version_compare(PHP_VERSION, '7.4.0', '<')) ? 'warn' :  'err' ));
	$driver=array(
