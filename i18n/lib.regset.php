...
class RegionalSettings {
	 ...
	 */
	function __construct($region_id=FALSE, $param_prefix=FALSE, $dbconn=NULL) {
...
class RegionalSettingsManager {
	 ...
	 * 			if not given last connection will be used.
	 */
	function __construct( $param_prefix = FALSE, $dbconn = NULL ) {
	...
	function getDefaultRegion() {
		...
		$plt_man = $GLOBALS['platform_manager'] = new PlatformManager();
